...
namespace Proto.GateServerService
{
    ...
    {
        [API(10046)]G2C_GMTool GMTool(C2G_GMTool req);
        [API(10045)]G2C_EquipmentLevelUp EquipmentLevelUp(C2G_EquipmentLevelUp req);
        [API(10044)]G2C_SaleItem SaleItem(C2G_SaleItem req);
        [API(10043)]G2C_OperatorEquip OperatorEquip(C2G_OperatorEquip req);
        [API(10042)]G2C_GetLastBattle GetLastBattle(C2G_GetLastBattle req);
        [API(10041)]G2C_BeginGame BeginGame(C2G_BeginGame req);
        [API(10040)]G2C_CreateHero CreateHero(C2G_CreateHero req);
        [API(10039)]G2C_Login Login(C2G_Login req);
    ...
    {
        [API(10046)]public abstract Task<G2C_GMTool> GMTool(C2G_GMTool request);
        [API(10045)]public abstract Task<G2C_EquipmentLevelUp> EquipmentLevelUp(C2G_EquipmentLevelUp request);
        [API(10044)]public abstract Task<G2C_SaleItem> SaleItem(C2G_SaleItem request);
        [API(10043)]public abstract Task<G2C_OperatorEquip> OperatorEquip(C2G_OperatorEquip request);
        [API(10042)]public abstract Task<G2C_GetLastBattle> GetLastBattle(C2G_GetLastBattle request);
        [API(10041)]public abstract Task<G2C_BeginGame> BeginGame(C2G_BeginGame request);
        [API(10040)]public abstract Task<G2C_CreateHero> CreateHero(C2G_CreateHero request);
        [API(10039)]public abstract Task<G2C_Login> Login(C2G_Login request);
