...
namespace Proto {
  ...
  public static partial class ConstReflection {
    ...
    static ConstReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cgtjb25zdC5wcm90bxIFUHJvdG8iBgoEVm9pZCrxBAoJRXJyb3JDb2RlEgkK",
            ...
            "bWl0EBcSFAoQUGxheWVyTGV2ZWxMaW1pdBAYEhQKEFJlZnJlc2hUaW1lTGlt",
            "aXQQGRITCg9OZWVkSXRlbVF1YWxpdHkQGhIXChNOb1Byb3BlcnR5VG9SZWZy",
            "ZXNoEBsSEwoPTWFnaWNOb0FjdGljdGVkEBxiBnByb3RvMw=="));
  ...
  public enum ErrorCode {
    ...
    ///等级过高
    /// </summary>
    [pbr::OriginalName("PlayerLevelLimit")] PlayerLevelLimit = 24,
    /// <summary>
    ///超过了最大可刷新次数
    /// </summary>
    [pbr::OriginalName("RefreshTimeLimit")] RefreshTimeLimit = 25,
    /// <summary>
    ///道具品质不够
    /// </summary>
    [pbr::OriginalName("NeedItemQuality")] NeedItemQuality = 26,
    /// <summary>
    ///属性不够无法刷新
    /// </summary>
    [pbr::OriginalName("NoPropertyToRefresh")] NoPropertyToRefresh = 27,
    /// <summary>
    ///魔法没有激活
    /// </summary>
    [pbr::OriginalName("MagicNoActicted")] MagicNoActicted = 28,
  }
