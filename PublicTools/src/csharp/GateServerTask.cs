...
namespace Proto.GateServerTask
{
    ...
    {
        [API(10051)]Task_G2C_JoinBattle JoinBattle(Task_G2C_JoinBattle req);
        [API(10050)]Task_G2C_SyncHero SyncHero(Task_G2C_SyncHero req);
        [API(10049)]Task_G2C_SyncPackage SyncPackage(Task_G2C_SyncPackage req);
    ...
    {
        [API(10051)]public abstract Task<Task_G2C_JoinBattle> JoinBattle(Task_G2C_JoinBattle request);
        [API(10050)]public abstract Task<Task_G2C_SyncHero> SyncHero(Task_G2C_SyncHero request);
        [API(10049)]public abstract Task<Task_G2C_SyncPackage> SyncPackage(Task_G2C_SyncPackage request);
