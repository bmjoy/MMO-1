...
namespace Proto.GateBattleServerService
{
    ...
    {
        [API(10052)]G2B_BattleReward BattleReward(B2G_BattleReward req);
        [API(10051)]G2B_GetPlayerInfo GetPlayerInfo(B2G_GetPlayerInfo req);
    ...
    {
        [API(10052)]public abstract Task<G2B_BattleReward> BattleReward(B2G_BattleReward request);
        [API(10051)]public abstract Task<G2B_GetPlayerInfo> GetPlayerInfo(B2G_GetPlayerInfo request);
