...
public class GPUBillboardBuffer:XSingleton<GPUBillboardBuffer>
{
    ...
    Vector2[]           mInitialSpeedXY;
    Vector2[]           mAccelerationXY;
    Vector3[]           mLifeSpanParam;
	...
	//-------------------------------------------------------------------------------------------//
    public void DisplayNumber(string numString, Vector2 size, Vector3 center, Color clr, bool haveScale)
	{
    ...
    public void DisplayNumberRandom(string numString, Vector2 size, Vector3 center, Color clr, bool haveScale, DisplayNumerInputParam inpuParam)
    {
        ...
        randomspeed.x = UnityEngine.Random.Range(inpuParam.RandomXInitialSpeedMin, inpuParam.RandomXInitialSpeedMax);
